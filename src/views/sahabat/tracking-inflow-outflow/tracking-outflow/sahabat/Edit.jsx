...
function EditTrackingOutflowSahabat({ trackingOutflowSahabat }) {
  ...
  // Modal
  const [
    isModalEditTrackingOutflowSahabat,
    setIsModalEditTrackingOutflowSahabat,
  ] = useState(false);
  const openModalEditTrackingOutflowSahabat = () =>
    setIsModalEditTrackingOutflowSahabat(true);
  ...
  return (
    <div>
      <Button className="editBtn" onClick={openModalEditTrackingOutflowSahabat}>
        Kemas Kini
      </Button>{" "}
      <Modal
        show={isModalEditTrackingOutflowSahabat}
        onHide={closeModalEditTrackingOutflowSahabat}
        backdrop="static"
        keyboard={false}
      >
        ...
        <Modal.Footer>
          <Button
            variant="secondary"
            onClick={closeModalEditTrackingOutflowSahabat}
          >
            Batal
          </Button>
