...
function EditTrackingOutflowIsiRumah({ trackingOutflowIsiRumah }) {
  // ----------FE----------
  // Modal
  const [isModalEditTrackingOutflowIsiRumah, setIsModalEditTrackingOutflowIsiRumah] = useState(false);
  const openModalEditTrackingOutflowIsiRumah = () => setIsModalEditTrackingOutflowIsiRumah(true);
  ...
  return (
    <div>
      <Button className="editBtn" onClick={openModalEditTrackingOutflowIsiRumah}>Kemas Kini</Button>{" "}
      
      <Modal show={isModalEditTrackingOutflowIsiRumah} onHide={closeModalEditTrackingOutflowIsiRumah} backdrop="static" keyboard={false}>
        ...
        <Modal.Footer>
          <Button variant="secondary" onClick={closeModalEditTrackingOutflowIsiRumah}>Batal</Button>
