        ...
        <Table responsive>
          ...
          <tbody>
            ...
            <tr>
              <td colSpan="5">
                <center>
                  No information on the week tracking. Click "Add Week" button
                  to record a new week.
                </center>
              </td>
            </tr>
            {/* ) : ( */}
            ...
            // }
            >
              <td className="sc-completion-indicator">Num. of Week</td>
              <td className="sc-completion-indicator">Total Inflow</td>
              <td className="sc-completion-indicator">Total Outflow</td>
