...
function EditKodInflow({ kodInflowId }) {
  ...
  return (
    <div>
      <Button className="editBtn" onClick={openModalEditKodInflow}>
        Kemas Kini
      </Button>{" "}
      <Modal
        show={isModalEditKodInflow}
        onHide={closeModalEditKodInflow}
        backdrop="static"
        keyboard={false}
      >
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit(updateKodInflow)} onReset={reset}></Form>
        </Modal.Body>

        <Modal.Footer>
          <Button variant="secondary" onClick={closeModalEditKodInflow}>
            Batal
          </Button>
          <Button variant="primary" onClick={handleSubmit(updateKodInflow)}>
            Simpan
          </Button>
        </Modal.Footer>
      </Modal>
