...
function SearchProfilSahabatTerperinci() {
    ...
    const [ isSearchResultPembiayaanTerperinciSahabatVisible, setIsSearchResultPembiayaanTerperinciSahabatVisible ] = useState(false);
    const handleSearchResultPembiayaanTerperinciVisibility = () => {
        setIsSearchResultPembiayaanTerperinciSahabatVisible(!isSearchResultPembiayaanTerperinciSahabatVisible);
    };
            ...
            <div className='carianPembiayaanSahabat'>
                ...
                <Container>
                    <Row>
                        ...
                        <Col xs={12} xl={2}>
                            <Button className='cariPembiayaanBtn' onClick={handleSearchResultPembiayaanTerperinciVisibility}>
                                Cari
                            </Button>
                        </Col>
                    </Row>
